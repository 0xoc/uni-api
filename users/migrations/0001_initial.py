# Generated by Django 2.1.7 on 2019-04-19 12:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_enumfield.db.fields.EnumField(default=0, enum=users.models.CourseStatusType)),
                ('approved', django_enumfield.db.fields.EnumField(default=0, enum=users.models.CourseApprovalState)),
            ],
        ),
        migrations.CreateModel(
            name='Carrier',
            fields=[
                ...
                ('admission_type', django_enumfield.db.fields.EnumField(default=0, enum=users.models.AdmissionType)),
            ],
        ),
        migrations.CreateModel(
            name='College',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students_gender', django_enumfield.db.fields.EnumField(default=0, enum=users.models.GenderTypeAllowed)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='field_courses', to='users.Credit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_type', django_enumfield.db.fields.EnumField(default=0, enum=users.models.FieldCourseType)),
        ...
        migrations.AddField(
            model_name='course',
            name='departments',
            field=models.ManyToManyField(related_name='allowed_courses', to='users.Department', verbose_name='Departments allowed to register the course'),
        ),
        migrations.AddField(
            model_name='course',
            name='field_course',
        ...
        migrations.AddField(
            model_name='course',
            name='subfields',
            field=models.ManyToManyField(related_name='allowed_courses', to='users.Subfield', verbose_name='Subfields allowed to register the course'),
        ),
        migrations.AddField(
            model_name='course',
            name='term',
        ...
        migrations.AddField(
            model_name='carrier',
            name='entry_term',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entered_carriers', to='users.Term'),
        ),
        migrations.AddField(
            model_name='carrier',
            name='login_profile',
